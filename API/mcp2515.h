...
#define TXBnCTRL(n) 0x30+(n*0x10)		/*¼Ä´æÆ÷¡¤µØÖ·*/
#define RXBnCTRL(n) 0x60+(n*0x10)		/*¼Ä´æÆ÷¡¤µØÖ·*/
/* Exported types ------------------------------------------------------------*/
void    Mcp2515Init(void);
void    Mcp2515WriteByte(uint8_t data, uint8_t adress);
uint8_t Mcp2515ReadByte(uint8_t adress);

void Mcp2515BitModify(uint8_t address, uint8_t mask, uint8_t data);
void Mcp2515WriteArray(uint8_t adress, uint8_t *data, uint8_t length);
